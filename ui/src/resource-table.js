...
const tableColumnDefinitions = {
    jobs: [{
            ...
            renderCell: params => {
                ...
                return <
                    Link href = {
                        `https://gitlab.com/Northern.tech/Mender/mender-qa/-/pipelines/${pipelineid}/jobs/${params.row.id}`
                    } > {
                        params.row.id
                    } < /Link>;
            },
        ...
        },
        {
            ...
            renderCell: params => < Link href = {
                `/pipelines/${params.row.pipeline_id}/jobs/${params.row.id}`
            } > {
                params.row.name
            } < /Link>,
            minWidth: 200,
    ...
    results: [{
            ...
            renderCell: params => ( <
                Link href = {
                    `https://gitlab.com/Northern.tech/Mender/mender-api-docs/-/pipelines/${params.row.pipeline_id}/jobs/${params.row.id}`
                } > {
                    ' '
                } {
                    params.row.id
        ...
        },
        {
            ...
            filterable: false,
            renderCell: params => < Link href = {
                `/pipelines/${params.row.id}/jobs/${params.row.jobId}/builds`
            } > {
        ...
        },
        {
            ...
            renderCell: params => < Link href = {
                `/tests/history?name=${encodeURIComponent(params.row.testName)}&count=10`
            } > {
                params.row.testName
            } < /Link>,
        },
...
const ResourceTable = ({
    ...
    return ( <
        DataGrid autoHeight showQuickFilter
        ...
        disableSelectionOnClick disableColumnSelector disableDensitySelector components = {
            {
                Toolbar: GridToolbar,
