...
const tableColumnDefinitions = {
    builds: [{
        ...
        },
        {
            ...
            renderCell: params => < Link href = {
                `/projects/${params.row.project_id}/builds/${params.row.id}`
            } > {
                params.row.name
            } < /Link>,
            minWidth: 200,
    ...
    results: [{
        ...
        },
        {
            ...
            filterable: false,
            renderCell: params => < Link href = {
                `/projects/${params.row.project_id}/builds`
            } > {
        ...
        },
        {
            ...
            renderCell: params => ( <
                Link href = {
                    `/projects/${params.row.project_id}/tests/history?name=${encodeURIComponent(params.row.test_name)}&count=10`
                } > {
                    ' '
                } {
